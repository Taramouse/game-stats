              ...
              <v-card color="blue-grey darken-2" class="white--text">
                <v-card-text>
                  <div class="editArea pa-4">
                    ...
                    <draggable v-model="profileHeaders" @start="drag=true" @end="drag=false">
                      <transition-group>
              ...
              <v-card>
                <v-container fluid grid-list-sm>
                  ...
                  <v-layout row wrap class="hidden-sm-and-down">
                    <v-flex xs12>
                      <v-card-text>
                        <v-data-table :headers="profileHeaders" :items="items" hide-actions disable-initial-sort class="elevation-1" dark>
                        </v-data-table>
        ...
        <v-card>
          <v-container>
            ...
            <v-layout row wrap>
              <v-flex xs12>
                <v-card-text>
                  <v-text-field name="name" label="Name" id="name" v-model="newHeader" :rules="statRules" :counter="3" required>
                  </v-text-field>
                </v-card-text>
              </v-flex>
            </v-layout>
